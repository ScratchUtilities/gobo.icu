...
function preview(type, output) {
    ...
    switch(type) {
    case "u":
	request("https://api." + output.substring(8), function(response) {
	...
	request("https://api." + output.substring(8), function(response) {
	    ...
	    stats.innerText = "" + json.stats.views + " views, " + json.stats.loves + " loves, " + json.stats.favorites + " favorites, " + json.stats.comments + " comments, " + json.stats.remixes + " remixes.";
	...
	break;
    case "s":
	request(output, function(response) {
	    var html = document.createElement("html");
	    html.innerHTML = response;
	    main.innerText = html.childNodes[0].childNodes[9].innerText.substring(17);
	    main.appendChild(document.createElement("br"));
	    var img = document.createElement("img");
	    img.src = "//cdn2.scratch.mit.edu/get_image/gallery/" + output.substring(31) + "_480x360.png";
	    main.appendChild(img);
	    var end = document.createElement("div");
	    end.style = "white-space: pre;";// allow multiple spaces in a row
	    // end contents
	    var describe = document.createElement("div")
	    describe.innerText = html.childNodes[2].childNodes[3].childNodes[5].childNodes[5].childNodes[1].childNodes[3].childNodes[9].childNodes[1].childNodes[1].childNodes[1].innerText;
	    end.appendChild(describe);
	    var intruct = document.createElement("div");
	    instruct.innerText = html.childNodes[2].childNodes[3].childNodes[5].childNodes[5].childNodes[1].childNodes[3].childNodes[9].childNodes[1].childNodes[1].childNodes[3].innerText;
	    end.appendChild(instruct);
	    var followers = document.createElement("div");
	    followers.innerText = html.childNodes[2].childNodes[3].childNodes[5].childNodes[5].childNodes[3].childNodes[1].childNodes[1].childNodes[3].childNodes[3].childNodes[1].innerText + " Followers"
	    ...
	    request(
		"https://scratch.mit.edu/site-api/projects/in/" + output.substring(31) + "/1/",
		function(response) {
